...
| **Good (B 60-69%)**            | Assets used are appropriate, high quality, and primarily third party. Good use of sound  | Provides an engaging experience. Addresses skill levels and provides a variety of challenges                     | The code follows good programming practise and works as expected without major issues. OO approach is used appropriately. Comments present where required. |
